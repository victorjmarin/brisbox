...
function loadOrders() {
    ...
    Orders.insert({
        name: 'Alberto',
        surname: 'García Perez',
        phone: '000000000',
        email: 'email1@gmail.com',
        numberBrisboxers: 2,
        zip: '41900',
        addressLoading: 'Paseo de la Palmera Sevilla',
        addressUnloading: '',
        hours: 2,
    ...
    Orders.insert({
        name: 'Maria',
        surname: 'Alvarez Guerrero',
        phone: '333333333',
        email: 'email2@gmail.com',
        numberBrisboxers: 3,
        zip: '41900',
        addressLoading: 'Calle Tetuán, Sevilla',
        addressUnloading: '',
        hours: 1,
        startMoment: '12:00 PM',
        canceled: false,
    ...
    Orders.insert({
        ...
        numberBrisboxers: 1,
        zip: '41900',
        addressLoading: 'Avenida Torneo, Sevilla',
        addressUnloading: '',
        hours: 2,
        startMoment: '12:00 PM',
        canceled: false,
    ...
    Orders.insert({
        ...
        numberBrisboxers: 3,
        zip: '41900',
        addressLoading: 'Calle Sierpes, Sevilla',
        addressUnloading: '',
        hours: 1,
        startMoment: '12:00 PM',
        canceled: false,
        comments: 'Llamar al movil para confirmar',
        typeMove: 'unload',
        day: new Date('2016-07-01'),
    ...
    Orders.insert({
        ...
        numberBrisboxers: 2,
        zip: '41900',
        addressLoading: 'Calle Marqués del Duero, 41001 Sevilla',
        addressUnloading: '',
        hours: 1,
        startMoment: '12:00 PM',
        canceled: false,
    ...
    Orders.insert({
        ...
        numberBrisboxers: 3,
        zip: '41900',
        addressLoading: 'Calle Bailén, Sevilla',
        addressUnloading: '',
        hours: 1,
        startMoment: '12:00 PM',
        canceled: false,
    ...
    Orders.insert({
        name: 'Francisco',
        surname: 'Aranda Gomez',
        phone: '441112223',
        email: 'emailEpsilon@gmail.com',
        numberBrisboxers: 2,
        zip: '41900',
        addressLoading: 'Calle Padre Marchena, Sevilla',
        addressUnloading: '',
        hours: 1,
        startMoment: '12:00 PM',
        canceled: false,
